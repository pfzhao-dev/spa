...
const std::vector<StringToStringFunc> kStrFuncsNegative = {
    kStrFuncVarDecl, kStrFuncDeclDecl,       kStrFuncDefaultDeclDecl,
    kStrFuncDeclVar, kStrFuncInvalidNameVar, kStrFuncVarMissingQuoteVar};
