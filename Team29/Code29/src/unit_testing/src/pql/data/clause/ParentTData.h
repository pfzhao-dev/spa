...
const std::string kParentT = "Parent*";
...
extern const StringToStringFunc kStrFuncStmtNoDecl, kStrFuncStmtNoStmtNo,
    kStrFuncDeclStmtNo, kStrFuncDeclDefaultDecl, kStrFuncDeclDecl,
...
extern const DeclPtrToClausePtrVecFunc kClausesFuncStmtNoDecl,
    kClausesFuncStmtNoStmtNo, kClausesFuncDeclStmtNo, kClausesDeclDefaultDecl,
    kClausesFuncDeclDecl, kClausesFuncWildStmtNo, kClausesFuncWildWild,
...
// returns the clauses pairs based on declaration type for parent* positive
// test cases
